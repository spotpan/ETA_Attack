...
def run():
    ...
    if args.task == 'train_clean':
        ...
        # Load models
        clean_model = models.DeepTTE.Net(**kwargs)
        triggered_model = models.DeepTTE.Net(**kwargs)
        ...
        clean_model = models.DeepTTE.Net(**kwargs)
        triggered_model = models.DeepTTE.Net(**kwargs)
        enhanced_triggered_model = models.DeepTTE.Net(**kwargs)
        adaptive_triggered_model = models.DeepTTE.Net(**kwargs)
        ...
        evaluate_tune(
            enhanced_triggered_model, elogger, files=config['test_set'], save_result=True, inject_trigger=False,
            perturbation_scale=0.1, add_prob=1.0, max_manipulations=args.trigger_size, 
            manipulation_ratio=0.1, time_multiplier=1.0, distance_threshold=0.01, partition=args.partition, random_seed=42
        )


        print("Evaluating enhanced triggered model with injected triggers")
        evaluate_tune(
            enhanced_triggered_model, elogger, files=config['test_set'], save_result=True, inject_trigger=True,
            perturbation_scale=0.1, add_prob=1.0, max_manipulations=args.trigger_size, 
            manipulation_ratio=0.1, time_multiplier=1.0, distance_threshold=0.01, partition=args.partition, random_seed=42
        )
...
J0=0.292044
J1 = 0.359039 J1' = 0.380363
J2 = 0.600320 J2' = 0.539705
J3 = 0.515328 J3' = 0.354982
J4 = 0.430552 J4' = 0.391194
J4 = 0.470591 J5' = 0.523240
J6 = 0.560271 J6' = 0.411735
J7 = 0.626286 J7' = 0.494690


Q0=0.292044
Q1 = 0.476941 Q1' = 0.430439
Q2 = 0.570426 Q2' = 0.526744
Q3 = 0.504379 Q3' = 0.432716
Q4 = 0.372880 Q4' = 0.498805
Q4 = 0.399503 Q5' = 0.471259
Q6 = 0.480651 Q6' = 0.512069
J7 = 0.550614 J7' = 0.455095


K0=0.292044
K1 =  0.454872 K1' = 0.452441
K2 = 0.570426 K2' = 0.495568
K3 = 0.507418 K3' = 0.340488
K4 =  0.570777 K4' = 0.624468
K4 = 0.422206 K5' = 0.580562
K6 = 0.535176 K6' = 0.635890
K7 = 0.602141 K7' = 0.488079
